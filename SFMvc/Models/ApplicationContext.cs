    ...
    public class ApplicationContext : IdentityDbContext<ApplicationUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Show>().HasData(
                ...
                new Show { Id = 6, Title = "Chernobyl", Description= "En dramaserie från HBO i fem delar som följer händelserna kring kärnkraftsolyckan i Tjernobyl...", Format = "Miniserie", ImageUrl= "chernobyl.webp", LogoUrl= "hbo.jfif" },
                new Show { Id = 7, Title = "The Bear", Description= "Efter att hans bror har tagit livet av sig tar stjärnkocken Carmy...", Format = "Serie", ImageUrl= "thebear.webp", LogoUrl= "disney.png" },
                new Show { Id = 8, Title = "Guardians of the Galaxy Vol. 3", Description= "Peter Quill, som fortfarande sörjer förlusten av Gamora, måste ...", Format = "Film", ImageUrl= "guardiansvol3.jpg", LogoUrl= "disney.png" },
                new Show { Id = 9, Title = "Guardians of the Galaxy", Description= "Äventyraren Peter Quill stjäl en eftertraktad himlakropp från Ronan, s...", Format = "Film", ImageUrl= "guardians.jfif", LogoUrl= "disney.png" });
        }
    }
}
